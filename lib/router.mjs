...
// router.get('/ImmutableCollection/:collectionName/:b/:c/:a/:rest', pathTag, getCollection('ImmutableCollection'), invokeCollectionMethod);
// router.get('/MutableCollection/:collectionName/:b/:c/:a/:rest',   pathTag, getCollection('MutableCollection'),   invokeCollectionMethod);
// router.get('/VersionedCollection/:collectionName/:b/:c/:a/:rest', pathTag, getCollection('VersionedCollection'), invokeCollectionMethod);
// router.get('/VersionCollection/:collectionName/:b/:c/:a/:rest',   pathTag, getCollection('VersionCollection'),   invokeCollectionMethod);
...
router.put('/VersionCollection/:collectionName/:b/:c/:a/:rest',   pathTag, getCollection('VersionCollection'),   invokeCollectionMethod);
...
router.delete('/VersionCollection/:collectionName/:b/:c/:a/:rest',   pathTag, getCollection('VersionCollection'),   invokeCollectionMethod);
...
router.post('/requestDataChannel/:kind/:collectionName/:tag', async (req, res, next) => {
});
