...
export class PersistFileSystem {
  ...
  constructor({collection, collectionType = collection.constructor.name, collectionName = collection.name, dbName = storageName, dbVersion = storageVersion, temporarySubdirectory = 'temp'} = {}) {
    this.collectionName = collectionName;
    this.base = path.resolve(basePath(`${dbName}:${dbVersion}`, collectionType, collectionName));
