...
export class PersistFileSystem {
  ...
  constructor({collection, collectionType = collection.constructor.name, collectionName = collection.name, dbName = name, dbVersion = version, temporarySubdirectory = 'temp'} = {}) {
