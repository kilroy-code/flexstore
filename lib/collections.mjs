...
export class VersionedCollection extends MutableCollection {
  ...
  async mergeSignatures(validation, signature) { // Merge the new timestamps with the old.
    ...
    console.log(`*** Need to sign merge of ${this.name} ${JSON.stringify(previousTimestamps, null, 2)} + ${JSON.stringify(nextTimestamps, null, 2)} => ${JSON.stringify(revised, null, 2)}.`);
