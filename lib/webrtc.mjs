...
export class WebRTC {
  constructor({label = '', configuration = null, debug = false} = {}) {
...
export class SharedWebRTC extends PromiseWebRTC {
  static ensure({service, ...rest}) {
    // TODO: check for existing instance
    return new this(rest);
  }
  channelId = 0;
  ensureDataChannel(channelName, channelOptions, signals) { // Return a promise for an open data channel on this connection.
    ...
    // TODO: if negotiated, wait for connection
